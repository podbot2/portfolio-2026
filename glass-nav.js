(function () {
  ...
  css.textContent = [
    '#glass-nav{position:fixed;top:1.5rem;right:90px;z-index:9990;display:flex;align-items:center;gap:4px;background:rgba(255,255,255,0.08);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.12);border-radius:999px;padding:4px}',
