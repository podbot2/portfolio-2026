(function () {
  ...
  function init() {
    ...
    css.textContent = [
      ...
      /* ── Chat window ── */
      "#jf-chat-window{position:fixed;bottom:96px;right:28px;z-index:9998;width:380px;height:480px;background:#1a1a1a;border:1px solid rgba(255,255,255,.1);border-radius:16px;display:none;flex-direction:column;overflow:hidden;box-shadow:0 12px 48px rgba(0,0,0,.5);font-family:Inter,system-ui,sans-serif;transition:height .3s cubic-bezier(.4,0,.2,1)}",
      "#jf-chat-window.open{display:flex}",
      "#jf-chat-window.expanded{height:calc(100vh - 120px)}",
      /* ── Header ── */
      ...
      "#jf-chat-expand svg{fill:none !important}",
      /* ── Messages ── */
    ...
    win.innerHTML = [
      ...
      '<button id="jf-chat-expand" aria-label="Expand"><svg viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.5)" stroke-width="2" stroke-linecap="round"><line x1="4" y1="20" x2="10" y2="14"/><polyline points="4 14 4 20 10 20"/><line x1="20" y1="4" x2="14" y2="10"/><polyline points="20 10 20 4 14 4"/></svg></button>',
    ...
    function openChat() {
      ...
      if (typeof window.gtag === "function") { window.gtag("event", "chatbot_open", { event_category: "chatbot" }); }
